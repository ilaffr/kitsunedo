...
description: >
  ...
  вместо встроенных копий: explore, goap-research, problem-solver-enhanced. Поддерживает 
...
| Phase 1: Research | `goap-research` | `/mnt/skills/user/goap-research/SKILL.md` | GOAP A* + OODA → Research Findings |
...
- `goap-research` недоступен → прямой web_search по ключевым темам
...
### Phase 1: RESEARCH (делегация → goap-research skill)

```
view("/mnt/skills/user/goap-research/SKILL.md")
...
sparc-prd-mini MANUAL
  ...
  --research: [готовые findings от goap-research]
...
**Research Quality (via goap-research):**
...
- `/mnt/skills/user/goap-research/SKILL.md`
